...
let which_condition = Math.floor(Math.random() * 2);
var expert
var positive
...
function demo_radarRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of demo_radarComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function demo_radar_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of demo_radar_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function demo_radar_3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of demo_radar_3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function outro_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of outro_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
